...
namespace AtelierXNA
{
    public class MenuLan : Menu
    {
        ...
        public override void Initialize()
        {
            ...
            Composantes.Add(new Titre(Game, "Solo", "Arial", new Vector2(Game.Window.ClientBounds.Width / 5, Game.Window.ClientBounds.Height / 5), "Blanc", false, Color.White));
            ...
            Composantes.Add(new Titre(Game, "MultiJoueur", "Arial", new Vector2(4 * Game.Window.ClientBounds.Width / 5, Game.Window.ClientBounds.Height / 5), "Blanc", false, Color.White));
